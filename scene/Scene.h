...
public:
    std::vector<Shape*> spheres = {
        // Planes
        new Plane(Vec3d(0, 40.8, 81.6), Vec3d(.65, .85, .92), Vec3d(), Vec3d(-1, 0, 0), DIFF),   // Left
        new Plane(Vec3d(100, 40.8, 81.6), Vec3d(.98, .73, .83), Vec3d(), Vec3d(1, 0, 0), DIFF),  // Right
        new Plane(Vec3d(50, 40.8, 0), Vec3d(.75, .75, .75), Vec3d(), Vec3d(0, 0, -1), DIFF),    // Back
        new Plane(Vec3d(50, 40.8, 170), Vec3d(), Vec3d(), Vec3d(0, 0, 1), DIFF),                // Front
        new Plane(Vec3d(50, 0, 81.6), Vec3d(.75, .75, .75), Vec3d(), Vec3d(0, -1, 0), DIFF),      // Bottom
        new Plane(Vec3d(50, 81.6, 81.6), Vec3d(.66, .58, .85), Vec3d(), Vec3d(0, 1, 0), DIFF),  // Top
        // Spheres
